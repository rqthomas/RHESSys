													  ...
													  
{
	...
	for (i=0; i< num_reaches; ++i) {
		...
		stream_network_ini[i].NO3_in=0.0;
		stream_network_ini[i].NH4_in=0.0;
		stream_network_ini[i].DON_in=0.0;
		stream_network_ini[i].DOC_in=0.0;
		stream_network_ini[i].NO3_out=0.0;
